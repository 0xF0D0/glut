...
func fontPtr(font int) unsafe.Pointer {
	switch font {
	case STROKE_ROMAN:
		return C.const_GLUT_STROKE_ROMAN()
	case STROKE_MONO_ROMAN:
		return C.const_GLUT_STROKE_MONO_ROMAN()
	case BITMAP_9_BY_15:
		return C.const_GLUT_BITMAP_9_BY_15()
	case BITMAP_8_BY_13:
		return C.const_GLUT_BITMAP_8_BY_13()
	case BITMAP_TIMES_ROMAN_10:
		return C.const_GLUT_BITMAP_TIMES_ROMAN_10()
	case BITMAP_TIMES_ROMAN_24:
		return C.const_GLUT_BITMAP_TIMES_ROMAN_24()
	case BITMAP_HELVETICA_10:
		return C.const_GLUT_BITMAP_HELVETICA_10()
	case BITMAP_HELVETICA_12:
		return C.const_GLUT_BITMAP_HELVETICA_12()
	case BITMAP_HELVETICA_18:
		return C.const_GLUT_BITMAP_HELVETICA_18()
	}
	panic("unknown font")
}
